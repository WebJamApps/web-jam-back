...
export const ZIP_COORDINATES: Record<string, [number, number]> = {
  ...
  '23219': [37.5407, -77.436],
  '23220': [37.5502, -77.4646],
...
export const CITY_COORDINATES: Record<string, [number, number]> = {
  ...
  'bedford': [37.3343, -79.5228],
  'bedford, va': [37.3343, -79.5228],
  ...
  'callaway': [36.984, -80.0934],
  'callaway, va': [36.984, -80.0934],
  ...
  'damascus': [36.6335, -81.7832],
  'damascus, va': [36.6335, -81.7832],
  ...
  'greensboro': [36.0711, -79.7793],
  'greensboro, nc': [36.0711, -79.7793],
  'grottoes': [38.2215, -78.8343],
  'grottoes, va': [38.2215, -78.8343],
  'harrisonburg': [38.4285, -78.871],
  'harrisonburg, va': [38.4285, -78.871],
  'high point': [35.9559, -79.9986],
  'high point, nc': [35.9559, -79.9986],
  'lexington': [37.784, -79.4428],
  'lexington, va': [37.784, -79.4428],
  ...
  'troutville': [37.419, -79.8761],
  'troutville, va': [37.419, -79.8761],
